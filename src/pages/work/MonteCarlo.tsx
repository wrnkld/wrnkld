...
const customerFeedback = [
  { id: 1, customer: "Jaguar Land Rover", role: "Data Engineer", settings: "--", codeChanges: "Complete", terms: "--", cardSort: "Complete" },
  { id: 2, customer: "Verizon Connect", role: "Data Engineer", settings: "--", codeChanges: "--", terms: "--", cardSort: "DNP" },
  { id: 3, customer: "Monday", role: "Data Engineer", settings: "--", codeChanges: "Complete", terms: "--", cardSort: "--" },
  { id: 4, customer: "Skyscanner", role: "Data Engineer", settings: "--", codeChanges: "--", terms: "Complete", cardSort: "--" },
  { id: 5, customer: "Richemont", role: "Data Analyst", settings: "--", codeChanges: "--", terms: "--", cardSort: "Complete" },
  { id: 6, customer: "Virgin", role: "Data Engineer", settings: "Complete", codeChanges: "--", terms: "--", cardSort: "--" },
  { id: 7, customer: "Auto Trader", role: "Data Engineer", settings: "--", codeChanges: "--", terms: "Complete", cardSort: "--" },
  { id: 8, customer: "Richemont", role: "Data Scientist", settings: "--", codeChanges: "Complete", terms: "--", cardSort: "--" },
  ...
  { id: 11, customer: "Skyscanner", role: "Data Engineer", settings: "Complete", codeChanges: "--", terms: "--", cardSort: "--" },
  ...
  { id: 15, customer: "Richemont", role: "Data Engineer", settings: "--", codeChanges: "--", terms: "Complete", cardSort: "--" },
];
